# XRAY Mini App Cardano Assets implementation 0001 result

Result-Version: v1
Implementation-ID: xray-mini-app-assets/0001
...
Installed SPECTRE 1.0.0 for XRAY Mini App Cardano Assets and replaced the active XRAY Updates installation. Historical terminal work is available through the SPECTRE archive; planned work remains active.
