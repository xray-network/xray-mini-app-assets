# xray-mini-app-assets implementation 0008 instruction
...
Remove rem transformation and convert active Assets styling to explicit pixels.
...
| C03       | Convert every active rem dimension at the configured 14px root.   | Preserve rendered dimensions.                                                | Styles/components | Static audit. |
