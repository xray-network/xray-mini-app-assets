# xray-mini-app-assets implementation 0012 instruction

Implementation-Version: v1
Implementation-ID: xray-mini-app-assets/0012
...
Apply the validated React Router 8 migration contract to Assets.
