...
## xray-mini-app-assets implementation status

Target: xray-mini-app-assets
...
| `0005` | Adopt Cardano bridge adapter         | [Instruction](./implementations/0005-IMPL-INSTR.md) | `REVIEW`   | [Result](./implementations/0005-IMPL-RESULT.md) | `LOCAL`       | Cardano hook/type migration, typecheck, and build pass and await human review.                                                       |
...
| `0015` | Adopt grouped Cardano utilities      | [Instruction](./implementations/0015-IMPL-INSTR.md) | `REVIEW`   | [Result](./implementations/0015-IMPL-RESULT.md) | `LOCAL`       | Grouped utility migration, typecheck, and production build pass and await human review.                                              |
| `0016` | Adopt scope-versioned bridge client  | [Instruction](./implementations/0016-IMPL-INSTR.md) | `REVIEW`   | [Result](./implementations/0016-IMPL-RESULT.md) | `LOCAL`       | Direct versioned bridge migration, typecheck, and production build pass; awaiting human review.                                      |
